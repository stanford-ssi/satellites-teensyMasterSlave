 ...
 * Aug 8th(ish) 2017
 *
 * This program generates a varying sinusoid in X and Y, initializes the SPI, initializes the DAC, sets a period (loop delay for now, will use timers later)
...
const int LASER_EN_PIN = 7;
const int FILTER_CUTOFF_HZ = 100; //filter cutoff frequency in Hz
